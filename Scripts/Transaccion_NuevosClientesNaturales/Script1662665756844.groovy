...
WebUI.setText(findTestObject('Object Repository/Page_OSCUS Business/input_Es menor de edad_txtIdentificacion'), Documento)
...
WebUI.verifyElementText(findTestObject('Object Repository/ObjXpath/Mensaje_PrimerAceptar'), 'Cliente ingresado correctamente.')
